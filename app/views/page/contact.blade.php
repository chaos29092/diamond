...
@section('title')
    NUCL - {{Lang::get('page.contact')}}
@stop
@section('keywords')
    {{Lang::get('page.contact')}}
@stop
@section('description')
    {{Lang::get('page.contact')}}
@stop
...
@section('side_content')
    <div class="col2">
        <div class="contact">
            <h3 class="heading colr">{{Lang::get('page.get_in_touch')}}</h3>
            <div class="mapsec">
                <p>{{Lang::get('page.contact_1')}}<br/><br/></p>
                ...
                <br />
                <p>
                    <span class="bold">Phone:</span> xxxxxxxxx<br /><br/>
